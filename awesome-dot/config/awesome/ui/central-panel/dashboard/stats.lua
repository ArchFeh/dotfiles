...
local temp_color = beautiful.xcolor5
...
awesome.connect_signal("signal::temp", function(value)
	temp.slider.value = value
	temp_tooltip.markup = helpers.colorize_text(value .. "°C", temp_color)
end)
