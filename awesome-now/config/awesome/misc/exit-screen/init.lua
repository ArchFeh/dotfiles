...
local lock_screen = require("misc.lockscreen")
lock_screen.init()
...
local poweroff_command = function()
	...
	awesome.emit_signal("misc::exit_screen:hide")
end
...
awesome.connect_signal("misc::exit_screen:show", function()
	for s in screen do
...
awesome.connect_signal("misc::exit_screen:hide", function()
