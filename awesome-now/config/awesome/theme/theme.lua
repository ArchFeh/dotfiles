...
theme.dock_focused_bg = theme.xforeground
...
theme.gentoo = theme_dir .. "assets/icons/gentoo.svg"
-- Icon theme
theme.icon_theme = nil

-- Fonts
theme.font_name = "Iosevka Nerd Font Mono "
--theme.font_name = "Noto Sans CJK SC "
